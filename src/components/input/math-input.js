...
var i18n = window.i18n || { _: function _(s) {
        return s;
    } };
    ...
    function MathInput() {
        ...
        return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = MathInput.__proto__ || Object.getPrototypeOf(MathInput)).call.apply(_ref, [this].concat(args))), _this), _this.state = {
            ...
            if (!_this._keypadBounds) {
                var node = _this.props.keypadElement.getDOMNode();
            ...
            _this.setState({ focused: true }, function () {
                ...
                setTimeout(function () {
                    if (_this._isMounted) {
                        ...
                        var maybeKeypadNode = _this.props.keypadElement && _this.props.keypadElement.getDOMNode();
